...
int UIKit_CreateWindow(_THIS, SDL_Window *window) {
	...
	//MyOverlayView *overlayView = [[MyOverlayView alloc] initWithView];    	
	//[uiwindow addSubview:overlayView];
	...
	CGRect frame = CGRectMake(rect.origin.x + 0, rect.size.height - 1 - 2, rect.size.width - (0 + 0), 10);
	...
	[uiwindow addSubview:segmentedControl];
